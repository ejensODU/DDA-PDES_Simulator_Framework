...
Grid_VN2D_Packet::Grid_VN2D_Packet()
: Entity(),
_originNetworkNodeID(0),
_destNetworkNodeID(0),
_destX(0), _destY(0),
_gridSizeX(0), _gridSizeY(0),
_visitedNodeCnt(0) {}
...
Grid_VN2D_Packet::Grid_VN2D_Packet(double genTime, size_t originNetworkNodeID, size_t destNetworkNodeID,
    ...
    size_t maxPathLength = gridSizeX + gridSizeY;
...
const std::vector<size_t>& Grid_VN2D_Packet::getVisitedNetworkNodes() const {
    return _visitedNodes;
}

size_t Grid_VN2D_Packet::getVisitedNodeCnt() const {
